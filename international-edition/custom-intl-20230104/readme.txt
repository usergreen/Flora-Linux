...
updated: 01-04 20:29 JST

This is a custom version, which has a Windows XP-like desktop view and feeling as it adopts double-click instead of single-click, and support for multilingual use.
...
As for this snapshot, it is labeled "Flora-Linux-21.2.1_x64 (bullseye-11.6), January 04, 2023" as shown at the boot menu.
