...
As for this snapshot, it is labeled "Flora-Linux-ja-21.2.1_x64 (bullseye-11.6), January 03, 2023" as shown at the boot menu.
...
quiet p_static_root lang=ja_JP kbd=jp tz=Asia/Tokyo
But if your USB device is set read-only mode, persistence will be disabled by default.
...
Alternatively, C locale is also supported. 
