...
This snapshot provides a full-featured Xfce Desktop environment. In order to make it certain, it has been modified thoroughly from Official MX-23_x64 31 July 2023.
As for this snapshot, it is labeled "Flora-Linux-23_x64 as shown at the boot menu.
...
Modified from the Official release of MX-23_x64 31 July 2023
...
Note:
Default language (locale) is not set.
