...
updated: 05-08 02:48 UTC

This is the updated version which includes Xfce 4.18 release, and it added supports for multilingual use.
...
This snapshot provides a full-featured Xfce Desktop environment. In order to make it certain, it has been modified thoroughly from Official MX-21.3_x64 Wildflower 18 January 2023.
As for this snapshot, it is labeled "Flora-Linux-21.3_x64 (bullseye-11.7) as shown at the boot menu.
...
Modified from the Official release of MX-21.3_x64 Wildflower 18 January 2023
Downloaded from MX mirror at
https://ftp.riken.jp/Linux/mxlinux-iso/MX/Final/Xfce/

** Default localization (L10n)
The below locales are very well-supported:
